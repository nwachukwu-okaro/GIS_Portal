# Boundary Census Education Oa

## Overview

- **Identifier:** `a_ons_england_wales/boundary_census_education_oa`
- **Source organisation:** Office for National Statistics
- **Source:** https://www.ons.gov.uk/methodology/geography/geographicalproducts/digitalboundaries
- **Schema:** `a_ons_england_wales`
- **Table:** `boundary_census_education_oa`
- **Geometry:** GEOMETRY
- **CRS:** EPSG:27700
- **Rows:** 188880
...
Boundary Census Education Oa is an authoritative dataset published by Office for National Statistics. It represents boundary census education oa features using geometry geometry.
