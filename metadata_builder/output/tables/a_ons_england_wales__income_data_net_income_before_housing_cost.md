...
| `disposable_net_annual_income_before_housing_costs` | `text` | Publisher-supplied disposable net annual income before housing costs for the represented feature or record. |
