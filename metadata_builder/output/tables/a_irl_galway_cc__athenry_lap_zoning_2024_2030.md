...
| `zoning_abb` | `varchar` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
...
| `policy_o_1` | `varchar` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
| `globabl_id` | `varchar` | Identifier assigned by the source dataset. | identifier | Yes | No | No |
| `myplan_gzt` | `varchar` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
