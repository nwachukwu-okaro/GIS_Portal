...
|---|---|---|
| `pnha_pk` | `integer` | Count or numeric value for pnha pk in the represented area. |
...
| `source_scale` | `varchar(50)` | Publisher-supplied source scale for the represented feature or record. |
