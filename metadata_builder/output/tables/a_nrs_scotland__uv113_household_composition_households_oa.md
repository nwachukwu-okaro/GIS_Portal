...
| `one_family_household_married_or_civil_partnership_couple_total` | `double precision` | Count or numeric value for one family household married or civil partnership couple total in the represented area. |
| `one_family_household_married_or_civil_partnership_couple_no_chi` | `double precision` | Count or numeric value for one family household married or civil partnership couple number chi in the represented area. |
| `one_family_household_married_or_civil_partnership_couple_one_de` | `double precision` | Count or numeric value for one family household married or civil partnership couple one de in the represented area. |
| `one_family_household_married_or_civil_partnership_couple_two_or` | `double precision` | Count or numeric value for one family household married or civil partnership couple two or in the represented area. |
| `one_family_household_married_or_civil_partnership_couple_all_ch` | `double precision` | Count or numeric value for one family household married or civil partnership couple all ch in the represented area. |
...
| `one_family_household_cohabiting_couple_two_or_more_dependent_ch` | `double precision` | Count or numeric value for one family household cohabiting couple two or more dependent ch in the represented area. |
| `one_family_household_cohabiting_couple_all_children_non_depende` | `double precision` | Count or numeric value for one family household cohabiting couple all children non depende in the represented area. |
...
| `one_family_household_lone_parent_family_two_or_more_dependent_c` | `double precision` | Numeric one family household lone parent family two or more dependent c value recorded for the feature. |
| `one_family_household_lone_parent_family_all_children_non_depend` | `double precision` | Numeric one family household lone parent family all children non depend value recorded for the feature. |
