...
| `staying_temporarily_no_usual_uk_address` | `bigint` | Count or numeric value for staying temporarily number usual uk address in the represented area. | statistical_value | Yes | No | No |
