# OS Open Built Up Extents

## Overview

- **Identifier:** `a_os_built_up_areas/os_open_built_up_extents`
...
OS Open Built Up Extents is part of OS Open Built Up Areas, published by Ordnance Survey. It represents built up extents features using multipolygon geometry.
