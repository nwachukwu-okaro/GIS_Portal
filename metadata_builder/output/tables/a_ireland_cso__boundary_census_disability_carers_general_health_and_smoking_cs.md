# Boundary Census Disability Carers General Health And Smoking Cs

## Overview

- **Identifier:** `a_ireland_cso/boundary_census_disability_carers_general_health_and_smoking_cs`
- **Source organisation:** Central Statistics Office Ireland
- **Source:** https://www.cso.ie/en/databases/
- **Geographic coverage:** Ireland
- **WGS84 extent:** `[-1.726726, 54.563349, 3.417194, 58.519873]`
- **Schema:** `a_ireland_cso`
- **Table:** `boundary_census_disability_carers_general_health_and_smoking_cs`
- **Geometry:** GEOMETRY
- **CRS:** EPSG:27700
- **Rows:** 3420
- **Columns:** 36
...
Boundary Census Disability Carers General Health And Smoking Cs is an authoritative dataset published by Central Statistics Office Ireland. It represents boundary census disability carers general health and smoking cs features using geometry geometry.
