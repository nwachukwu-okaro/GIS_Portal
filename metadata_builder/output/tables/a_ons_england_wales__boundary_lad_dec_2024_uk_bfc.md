# Boundary Lad Dec 2024 UK Bfc

## Overview

- **Identifier:** `a_ons_england_wales/boundary_lad_dec_2024_uk_bfc`
...
- **Table:** `boundary_lad_dec_2024_uk_bfc`
...
Boundary Lad Dec 2024 UK Bfc is an authoritative dataset published by Office for National Statistics. It represents boundary lad dec 2024 uk bfc features using multipolygon geometry.
