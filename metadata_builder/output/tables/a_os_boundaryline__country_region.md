...
- **Identifier:** `a_os_boundaryline/country_region`
...
Country Region is part of Boundary-Line, published by Ordnance Survey. It represents country region features using multipolygon geometry.
