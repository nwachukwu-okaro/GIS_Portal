...
| `font_height` | `varchar` | Publisher-supplied font height for the represented feature or record. |
| `text_orientation` | `integer` | Count or numeric value for text orientation in the represented area. |
