...
| `population` | `text` |  |
| `ethnic_group_other_ethnic_groups` | `text` | Recorded census measure for the category "ethnic group other ethnic groups" in the represented area. Units and population base require the source table. |
...
| `religion_or_religion_brought_up_in_protestant_other_christian_i` | `text` |  |
...
| `religion_methodist` | `text` | Recorded census measure for the category "religion methodist" in the represented area. Units and population base require the source table. |
...
| `religion_other_christian_religions` | `text` | Recorded census measure for the category "religion other christian religions" in the represented area. Units and population base require the source table. |
...
| `religion_presbyterian` | `text` | Recorded census measure for the category "religion presbyterian" in the represented area. Units and population base require the source table. |
