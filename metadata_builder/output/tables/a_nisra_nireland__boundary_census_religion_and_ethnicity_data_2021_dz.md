...
| `ethnic_group_other_ethnic_groups` | `bigint` | Publisher-supplied ethnic group other ethnic groups for the represented feature or record. |
...
| `religion_or_religion_brought_up_in_protestant_other_christian_i` | `bigint` | Publisher-supplied religion or religion brought up in protestant other christian i for the represented feature or record. |
| `religion_catholic` | `text` | Publisher-supplied religion catholic for the represented feature or record. |
| `religion_church_of_ireland` | `bigint` | Publisher-supplied religion church of ireland for the represented feature or record. |
| `religion_methodist` | `bigint` | Publisher-supplied religion methodist for the represented feature or record. |
| `religion_no_religion_not_stated` | `bigint` | Publisher-supplied religion number religion not stated for the represented feature or record. |
...
| `religion_presbyterian` | `bigint` | Publisher-supplied religion presbyterian for the represented feature or record. |
