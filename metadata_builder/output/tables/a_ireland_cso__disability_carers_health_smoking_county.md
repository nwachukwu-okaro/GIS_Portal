# Disability Carers Health Smoking County

## Overview

- **Identifier:** `a_ireland_cso/disability_carers_health_smoking_county`
- **Source organisation:** Central Statistics Office Ireland
- **Source:** https://www.cso.ie/en/databases/
- **Schema:** `a_ireland_cso`
- **Table:** `disability_carers_health_smoking_county`
...
Disability Carers Health Smoking County is an authoritative dataset published by Central Statistics Office Ireland. It contains records relating to disability carers health smoking county.
