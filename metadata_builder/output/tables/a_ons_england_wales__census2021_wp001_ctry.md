...
| `countries code` | `varchar` | Publisher-assigned countries code for the record. |
| `countries label` | `varchar` | Publisher-supplied countries label for the represented feature or record. |
