# Principal Status County

## Overview

- **Identifier:** `a_ireland_cso/principal_status_county`
...
Principal Status County is an authoritative dataset published by Central Statistics Office Ireland. It contains records relating to principal status county.
