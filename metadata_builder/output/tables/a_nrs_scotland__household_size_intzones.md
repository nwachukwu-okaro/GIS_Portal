...
| `gas_central_heating_other_gas_including_liquid_petroleum_gas` | `double precision` |  |
...
| `wood_or_biomass_including_logs_pellets_chippings_central_hea` | `double precision` |  |
| `other_renewable_energy_source_including_electric_and_air_hea` | `double precision` |  |
