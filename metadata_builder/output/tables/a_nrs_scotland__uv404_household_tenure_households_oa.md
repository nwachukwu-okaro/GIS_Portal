# Uv404 Household Tenure Households Oa

## Overview

- **Identifier:** `a_nrs_scotland/uv404_household_tenure_households_oa`
...
- **Table:** `uv404_household_tenure_households_oa`
...
Uv404 Household Tenure Households Oa is an authoritative dataset published by National Records of Scotland. It contains records relating to uv404 household tenure households oa.
...
| `social_rented_council_la_or_housing_association_registered_soci` | `double precision` | Count or numeric value for social rented council la or housing association registered soci in the represented area. |
