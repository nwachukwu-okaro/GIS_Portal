...
| `europe_united_kingdom_great_britain_not_otherwise_specified` | `bigint` |  |
| `europe_united_kingdom_united_kingdom_not_otherwise_specified` | `bigint` |  |
| `europe_other_europe` | `bigint` |  |
| `europe_other_europe_eu_countries` | `bigint` |  |
| `europe_other_europe_eu_countries_member_countries_in_march_2001` | `bigint` |  |
| `europe_other_europe_eu_countries_member_countries_in_march_20_1` | `bigint` |  |
| `europe_other_europe_eu_countries_member_countries_in_march_20_2` | `bigint` |  |
| `europe_other_europe_eu_countries_member_countries_in_march_20_3` | `bigint` |  |
| `europe_other_europe_eu_countries_member_countries_in_march_20_4` | `bigint` |  |
| `europe_other_europe_eu_countries_member_countries_in_march_20_5` | `bigint` |  |
| `europe_other_europe_eu_countries_member_countries_in_march_20_6` | `bigint` |  |
| `europe_other_europe_eu_countries_member_countries_in_march_20_7` | `bigint` |  |
| `europe_other_europe_eu_countries_countries_that_joined_the_eu_b` | `bigint` |  |
| `europe_other_europe_eu_countries_countries_that_joined_the_eu_1` | `bigint` |  |
| `europe_other_europe_eu_countries_countries_that_joined_the_eu_2` | `bigint` |  |
| `europe_other_europe_eu_countries_countries_that_joined_the_eu_3` | `bigint` |  |
| `europe_other_europe_eu_countries_countries_that_joined_the_eu_4` | `bigint` |  |
| `europe_other_europe_eu_countries_countries_that_joined_the_eu_5` | `bigint` |  |
| `europe_other_europe_eu_countries_countries_that_joined_the_eu_6` | `bigint` |  |
...
| `africa_africa_not_otherwise_specified` | `bigint` |  |
...
| `the_americas_and_the_caribbean_north_america_other_north_americ` | `bigint` |  |
| `the_americas_and_the_caribbean_central_america` | `bigint` |  |
| `the_americas_and_the_caribbean_central_america_all_central_amer` | `bigint` |  |
| `the_americas_and_the_caribbean_south_america` | `bigint` |  |
| `the_americas_and_the_caribbean_south_america_all_south_american` | `bigint` |  |
