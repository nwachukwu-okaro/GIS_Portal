...
| `other_households_no_adults_or_one_adult_and_one_or_more_childre` | `double precision` |  |
| `other_households_one_adult_aged_16_to_65_and_one_aged_66_and_ov` | `double precision` |  |
...
| `other_households_three_or_more_adults_and_one_or_more_children` | `double precision` |  |
