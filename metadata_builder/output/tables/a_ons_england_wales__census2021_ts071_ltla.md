...
| `previously_served_in_both_regular_and_reserve_uk_armed_forces` | `bigint` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
