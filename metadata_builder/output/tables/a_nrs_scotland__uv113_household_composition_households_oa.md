...
| `one_family_household_married_or_civil_partnership_couple_total` | `double precision` |  |
| `one_family_household_married_or_civil_partnership_couple_no_chi` | `double precision` |  |
| `one_family_household_married_or_civil_partnership_couple_one_de` | `double precision` |  |
| `one_family_household_married_or_civil_partnership_couple_two_or` | `double precision` |  |
| `one_family_household_married_or_civil_partnership_couple_all_ch` | `double precision` |  |
...
| `one_family_household_cohabiting_couple_two_or_more_dependent_ch` | `double precision` |  |
| `one_family_household_cohabiting_couple_all_children_non_depende` | `double precision` |  |
...
| `one_family_household_lone_parent_family_two_or_more_dependent_c` | `double precision` |  |
| `one_family_household_lone_parent_family_all_children_non_depend` | `double precision` |  |
