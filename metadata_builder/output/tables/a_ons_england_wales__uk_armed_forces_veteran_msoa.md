# UK Armed Forces Veteran Msoa

## Overview

- **Identifier:** `a_ons_england_wales/uk_armed_forces_veteran_msoa`
...
- **Table:** `uk_armed_forces_veteran_msoa`
...
UK Armed Forces Veteran Msoa is an authoritative dataset published by Office for National Statistics. It contains records relating to uk armed forces veteran msoa.
