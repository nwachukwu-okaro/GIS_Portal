# Boundary Census Irish Language County

## Overview

- **Identifier:** `a_ireland_cso/boundary_census_irish_language_county`
- **Source organisation:** Central Statistics Office Ireland
- **Source:** https://www.cso.ie/en/databases/
- **Geographic coverage:** Ireland
- **WGS84 extent:** `[-1.746471, 54.563349, 3.417194, 58.520162]`
- **Schema:** `a_ireland_cso`
- **Table:** `boundary_census_irish_language_county`
- **Geometry:** GEOMETRY
- **CRS:** EPSG:27700
- **Rows:** 31
- **Columns:** 42
...
Boundary Census Irish Language County is an authoritative dataset published by Central Statistics Office Ireland. It represents boundary census irish language county features using geometry geometry.
