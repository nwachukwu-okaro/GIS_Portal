...
| `the_americas_and_the_caribbean_north_america_and_the_caribbean` | `bigint` | Count or numeric value for the americas and the caribbean north america and the caribbean in the represented area. |
| `the_americas_and_the_caribbean_central_and_south_america` | `bigint` | Count or numeric value for the americas and the caribbean central and south america in the represented area. |
