# Household Structure Data 2021 Sdz

## Overview

- **Identifier:** `a_nisra_nireland/household_structure_data_2021_sdz`
...
- **Table:** `household_structure_data_2021_sdz`
...
Household Structure Data 2021 Sdz is an authoritative dataset published by Northern Ireland Statistics and Research Agency. It contains records relating to household structure data 2021 sdz.
...
| `household_composition_other_household_types_note_3` | `bigint` |  |
| `household_composition_single_family_all_pension_age_and_over_no` | `bigint` |  |
