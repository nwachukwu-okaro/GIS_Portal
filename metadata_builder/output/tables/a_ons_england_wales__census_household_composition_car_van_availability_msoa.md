# Census Household Composition Car Van Availability Msoa

## Overview

- **Identifier:** `a_ons_england_wales/census_household_composition_car_van_availability_msoa`
...
- **Table:** `census_household_composition_car_van_availability_msoa`
- **Geometry:** GEOMETRY
- **CRS:** EPSG:27700
- **Rows:** 7230
- **Columns:** 39
...
Census Household Composition Car Van Availability Msoa is an authoritative dataset published by Office for National Statistics. It represents census household composition car van availability msoa features using geometry geometry.
