...
| `total` | `integer` | Count or numeric value for total in the represented area. |
| `aged_4_years_and_under` | `integer` | Count or numeric value for aged 4 years and under in the represented area. |
| `aged_5_to_9_years` | `integer` | Count or numeric value for aged 5 to 9 years in the represented area. |
| `aged_10_to_14_years` | `integer` | Count or numeric value for aged 10 to 14 years in the represented area. |
| `aged_15_to_19_years` | `integer` | Count or numeric value for aged 15 to 19 years in the represented area. |
| `aged_20_to_24_years` | `integer` | Count or numeric value for aged 20 to 24 years in the represented area. |
| `aged_25_to_29_years` | `integer` | Count or numeric value for aged 25 to 29 years in the represented area. |
| `aged_30_to_34_years` | `integer` | Count or numeric value for aged 30 to 34 years in the represented area. |
| `aged_35_to_39_years` | `integer` | Count or numeric value for aged 35 to 39 years in the represented area. |
| `aged_40_to_44_years` | `integer` | Count or numeric value for aged 40 to 44 years in the represented area. |
| `aged_45_to_49_years` | `integer` | Count or numeric value for aged 45 to 49 years in the represented area. |
| `aged_50_to_54_years` | `integer` | Count or numeric value for aged 50 to 54 years in the represented area. |
| `aged_55_to_59_years` | `integer` | Count or numeric value for aged 55 to 59 years in the represented area. |
| `aged_60_to_64_years` | `integer` | Count or numeric value for aged 60 to 64 years in the represented area. |
| `aged_65_to_69_years` | `integer` | Count or numeric value for aged 65 to 69 years in the represented area. |
| `aged_70_to_74_years` | `integer` | Count or numeric value for aged 70 to 74 years in the represented area. |
| `aged_75_to_79_years` | `integer` | Count or numeric value for aged 75 to 79 years in the represented area. |
| `aged_80_to_84_years` | `integer` | Count or numeric value for aged 80 to 84 years in the represented area. |
| `aged_85_years_and_over` | `integer` | Count or numeric value for aged 85 years and over in the represented area. |
