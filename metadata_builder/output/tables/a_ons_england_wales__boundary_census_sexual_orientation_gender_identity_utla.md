...
| `not_answered_1` | `bigint` | Count or numeric value for not answered 1 in the represented area. | statistical_value | Yes | No | No |
...
| `trans_woman_1` | `bigint` | Count or numeric value for trans woman 1 in the represented area. | statistical_value | Yes | No | No |
| `trans_man_1` | `bigint` | Count or numeric value for trans man 1 in the represented area. | statistical_value | Yes | No | No |
| `all_other_gender_identities_1` | `bigint` | Count or numeric value for all other gender identities 1 in the represented area. | statistical_value | Yes | No | No |
