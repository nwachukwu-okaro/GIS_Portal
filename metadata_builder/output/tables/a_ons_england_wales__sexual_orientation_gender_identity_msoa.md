# Sexual Orientation Gender Identity Msoa

## Overview

- **Identifier:** `a_ons_england_wales/sexual_orientation_gender_identity_msoa`
...
- **Table:** `sexual_orientation_gender_identity_msoa`
...
Sexual Orientation Gender Identity Msoa is an authoritative dataset published by Office for National Statistics. It contains records relating to sexual orientation gender identity msoa.
