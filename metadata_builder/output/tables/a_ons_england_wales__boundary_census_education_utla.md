# Boundary Census Education Utla

## Overview

- **Identifier:** `a_ons_england_wales/boundary_census_education_utla`
...
- **Table:** `boundary_census_education_utla`
...
Boundary Census Education Utla is an authoritative dataset published by Office for National Statistics. It represents boundary census education utla features using multipolygon geometry.
