...
| `address_one_year_ago_different_address_within_northern_ireland` | `bigint` | Recorded census measure for the category "address one year ago different address within northern ireland" in the represented area. Units and population base require the source table. |
