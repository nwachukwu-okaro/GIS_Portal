# Uv115 Household Composition Alternative Child Adult Definit Oa

## Overview

- **Identifier:** `a_nrs_scotland/uv115_household_composition_alternative_child_adult_definit_oa`
- **Source organisation:** National Records of Scotland
- **Source:** https://www.nrscotland.gov.uk/statistics-and-data/geography/our-products
- **Geographic coverage:** Scotland
- **Schema:** `a_nrs_scotland`
- **Table:** `uv115_household_composition_alternative_child_adult_definit_oa`
...
Uv115 Household Composition Alternative Child Adult Definit Oa is an authoritative dataset published by National Records of Scotland. It contains records relating to uv115 household composition alternative child adult definit oa.
...
| `other_households_no_adults_or_one_adult_and_one_or_more_childre` | `double precision` | Count or numeric value for other households number adults or one adult and one or more childre in the represented area. | statistical_value | Yes | No | No |
| `other_households_one_adult_aged_16_to_65_and_one_aged_66_and_ov` | `double precision` | Count or numeric value for other households one adult aged 16 to 65 and one aged 66 and ov in the represented area. | statistical_value | Yes | No | No |
...
| `other_households_three_or_more_adults_and_one_or_more_children` | `double precision` | Count or numeric value for other households three or more adults and one or more children in the represented area. | statistical_value | Yes | No | No |
