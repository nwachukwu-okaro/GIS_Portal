# Boundary Census Occupations County

## Overview

- **Identifier:** `a_ireland_cso/boundary_census_occupations_county`
...
- **Table:** `boundary_census_occupations_county`
- **Geometry:** GEOMETRY
- **CRS:** EPSG:27700
- **Rows:** 31
- **Columns:** 38
...
Boundary Census Occupations County is an authoritative dataset published by Central Statistics Office Ireland. It represents boundary census occupations county features using geometry geometry.
