...
- **Identifier:** `a_os_boundaryline/district_borough_unitary`
...
- **Table:** `district_borough_unitary`
...
District Borough Unitary is part of Boundary-Line, published by Ordnance Survey. It represents district borough unitary features using multipolygon geometry.
