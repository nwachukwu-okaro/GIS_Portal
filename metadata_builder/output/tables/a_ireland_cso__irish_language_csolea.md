# Irish Language Csolea

## Overview

- **Identifier:** `a_ireland_cso/irish_language_csolea`
...
Irish Language Csolea is an authoritative dataset published by Central Statistics Office Ireland. It contains records relating to irish language csolea.
