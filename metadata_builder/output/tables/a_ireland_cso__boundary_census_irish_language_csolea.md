# Boundary Census Irish Language Csolea

## Overview

- **Identifier:** `a_ireland_cso/boundary_census_irish_language_csolea`
- **Source organisation:** Central Statistics Office Ireland
- **Source:** https://www.cso.ie/en/databases/
- **Geographic coverage:** Ireland
- **WGS84 extent:** `[-1.726726, 54.563349, 3.417194, 58.519873]`
- **Schema:** `a_ireland_cso`
- **Table:** `boundary_census_irish_language_csolea`
- **Geometry:** GEOMETRY
- **CRS:** EPSG:27700
- **Rows:** 166
- **Columns:** 41
...
Boundary Census Irish Language Csolea is an authoritative dataset published by Central Statistics Office Ireland. It represents boundary census irish language csolea features using geometry geometry.
