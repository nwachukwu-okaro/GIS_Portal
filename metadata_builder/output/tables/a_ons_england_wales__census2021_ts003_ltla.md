...
| `total_ single_family_hh_cohabiting_couple_family` | `bigint` | Count or numeric value for total single family households cohabiting couple family in the represented area. |
