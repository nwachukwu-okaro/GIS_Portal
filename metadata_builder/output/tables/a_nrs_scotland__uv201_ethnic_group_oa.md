...
| `asian_asian_scottish_or_asian_british_pakistani_pakistani_scott` | `double precision` |  |
| `asian_asian_scottish_or_asian_british_indian_indian_scottish_or` | `double precision` |  |
| `asian_asian_scottish_or_asian_british_bangladeshi_bangladeshi_s` | `double precision` |  |
| `asian_asian_scottish_or_asian_british_chinese_chinese_scottish` | `double precision` |  |
...
| `caribbean_or_black_caribbean_caribbean_scottish_or_caribbean_br` | `double precision` |  |
