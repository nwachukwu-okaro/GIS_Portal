...
|---|---|---|---|---|---|---|
| `papm_pk` | `integer` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
...
| `applicant_forename` | `varchar(2500)` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
| `applicant_surname` | `varchar(2500)` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
| `applicant_address` | `varchar(2500)` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
...
| `orig_fid` | `integer` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
