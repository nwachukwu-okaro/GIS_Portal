# Uv203 Multiple Ethnic Groups Oa

## Overview

- **Identifier:** `a_nrs_scotland/uv203_multiple_ethnic_groups_oa`
...
Uv203 Multiple Ethnic Groups Oa is an authoritative dataset published by National Records of Scotland. It contains records relating to uv203 multiple ethnic groups oa.
...
| `different_identities_within_partnerships_whether_or_not_also_di` | `double precision` | Count or numeric value for different identities within partnerships whether or not also di in the represented area. | statistical_value | Yes | No | No |
