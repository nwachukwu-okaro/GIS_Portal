# Principal Status Csolea

## Overview

- **Identifier:** `a_ireland_cso/principal_status_csolea`
...
Principal Status Csolea is an authoritative dataset published by Central Statistics Office Ireland. It contains records relating to principal status csolea.
