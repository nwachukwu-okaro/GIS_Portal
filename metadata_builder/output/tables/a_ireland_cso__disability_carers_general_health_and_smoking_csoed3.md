# Disability Carers General Health And Smoking Csoed3

## Overview

- **Identifier:** `a_ireland_cso/disability_carers_general_health_and_smoking_csoed3`
- **Source organisation:** Central Statistics Office Ireland
- **Source:** https://www.cso.ie/en/databases/
- **Schema:** `a_ireland_cso`
- **Table:** `disability_carers_general_health_and_smoking_csoed3`
...
Disability Carers General Health And Smoking Csoed3 is an authoritative dataset published by Central Statistics Office Ireland. It contains records relating to disability carers general health and smoking csoed3.
