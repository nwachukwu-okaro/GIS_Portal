...
| `household_composition_other_household_types_note_3` | `bigint` | Publisher-supplied household composition other household types note 3 for the represented feature or record. |
| `household_composition_single_family_all_pension_age_and_over_no` | `bigint` | Publisher-supplied household composition single family all pension age and over number for the represented feature or record. |
...
| `number_of_dependent_children_no_dependent_children_note_1` | `bigint` | Count or numeric value for number of dependent children number dependent children note 1 in the represented area. |
