# Uv407 Central Heating Oa

## Overview

- **Identifier:** `a_nrs_scotland/uv407_central_heating_oa`
- **Source organisation:** National Records of Scotland
- **Source:** https://www.nrscotland.gov.uk/statistics-and-data/geography/our-products
- **Geographic coverage:** Scotland
- **Schema:** `a_nrs_scotland`
- **Table:** `uv407_central_heating_oa`
...
Uv407 Central Heating Oa is an authoritative dataset published by National Records of Scotland. It contains records relating to uv407 central heating oa.
...
| `gas_central_heating_other_gas_including_liquid_petroleum_gas_an` | `double precision` | Count or numeric value for gas central heating other gas including liquid petroleum gas an in the represented area. | statistical_value | Yes | No | No |
...
| `wood_or_biomass_including_logs_pellets_chippings_central_heatin` | `double precision` | Count or numeric value for wood or biomass including logs pellets chippings central heatin in the represented area. | statistical_value | Yes | No | No |
| `other_renewable_energy_source_including_electric_and_air_heat_p` | `double precision` | Count or numeric value for other renewable energy source including electric and air heat p in the represented area. | statistical_value | Yes | No | No |
