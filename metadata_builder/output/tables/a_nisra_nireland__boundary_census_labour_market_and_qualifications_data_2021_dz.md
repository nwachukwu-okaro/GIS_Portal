...
| `economic_activity_in_employment` | `bigint` |  |
...
| `highest_level_of_qualifications_level_4_and_above` | `bigint` |  |
| `highest_level_of_qualifications_no_qualifications` | `bigint` |  |
...
| `hours_worked_per_week_31_48_hours` | `bigint` |  |
