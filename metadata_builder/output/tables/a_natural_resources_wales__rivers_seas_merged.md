...
- **Identifier:** `a_natural_resources_wales/rivers_seas_merged`
- **Source organisation:** Natural Resources Wales
- **WGS84 extent:** `[-5.353493, 51.377862, -2.649799, 53.430997]`
...
Rivers Seas Merged is an authoritative dataset published by Natural Resources Wales. It represents rivers seas merged features using multipolygon geometry.
