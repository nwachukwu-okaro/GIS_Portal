...
| `distance_travelled_to_study_outside_northern_ireland` | `text` | Count or numeric value for distance travelled to study outside northern ireland in the represented area. | statistical_value | Yes | No | No |
