# Accomodation Type People Intzones

## Overview

- **Identifier:** `a_nrs_scotland/accomodation_type_people_intzones`
- **Source organisation:** National Records of Scotland
- **Source:** https://www.nrscotland.gov.uk/statistics-and-data/geography/our-products
- **Geographic coverage:** Scotland
- **Schema:** `a_nrs_scotland`
- **Table:** `accomodation_type_people_intzones`
...
Accomodation Type People Intzones is an authoritative dataset published by National Records of Scotland. It contains records relating to accomodation type people intzones.
