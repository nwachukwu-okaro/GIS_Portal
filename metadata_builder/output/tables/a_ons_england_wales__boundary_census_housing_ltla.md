# Boundary Census Housing Ltla

## Overview

- **Identifier:** `a_ons_england_wales/boundary_census_housing_ltla`
...
- **Table:** `boundary_census_housing_ltla`
...
Boundary Census Housing Ltla is an authoritative dataset published by Office for National Statistics. It represents boundary census housing ltla features using multipolygon geometry.
