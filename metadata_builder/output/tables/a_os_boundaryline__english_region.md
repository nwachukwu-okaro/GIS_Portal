...
- **Identifier:** `a_os_boundaryline/english_region`
...
English Region is part of Boundary-Line, published by Ordnance Survey. It represents english region features using multipolygon geometry.
...
| `Area_Type_Description` | `varchar(26)` | Publisher-supplied area type description for the represented feature or record. | source_attribute | Yes | No | No |
