...
Etl is part of OS Open Zoomstack, published by Ordnance Survey. It represents etl features using multilinestring geometry.
...
|---|---|---|
| `id` | `integer` | Primary-key identifier for records in etl. |
