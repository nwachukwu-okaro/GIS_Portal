...
- **Identifier:** `a_ons_england_wales/gva_msoa`
...
Gva Msoa is an authoritative dataset published by Office for National Statistics. It contains records relating to gva msoa.
...
|---|---|---|
| `id` | `integer` | Primary-key identifier for records in gva_msoa. |
| `msoa code` | `varchar` |  |
| `msoa name` | `varchar` |  |
| `lad code` | `varchar` |  |
| `lad name` | `varchar` |  |
