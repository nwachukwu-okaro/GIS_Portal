...
- **Identifier:** `a_os_boundaryline/westminster_const`
...
Westminster Const is part of Boundary-Line, published by Ordnance Survey. It represents westminster const features using multipolygon geometry.
