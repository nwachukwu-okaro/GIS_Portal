# Boundary Census Education Msoa

## Overview

- **Identifier:** `a_ons_england_wales/boundary_census_education_msoa`
...
- **Table:** `boundary_census_education_msoa`
- **Geometry:** GEOMETRY
- **CRS:** EPSG:27700
- **Rows:** 7264
- **Columns:** 15
...
Boundary Census Education Msoa is an authoritative dataset published by Office for National Statistics. It represents boundary census education msoa features using geometry geometry.
