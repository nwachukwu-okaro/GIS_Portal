...
| `total_all_usual_residents_aged_5_and_over` | `bigint` | Count or numeric value for total all usual residents aged 5 and over in the represented area. | statistical_value | Yes | No | No |
