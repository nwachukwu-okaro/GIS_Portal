# Principal Status Bua

## Overview

- **Identifier:** `a_ireland_cso/principal_status_bua`
...
Principal Status Bua is an authoritative dataset published by Central Statistics Office Ireland. It contains records relating to principal status bua.
