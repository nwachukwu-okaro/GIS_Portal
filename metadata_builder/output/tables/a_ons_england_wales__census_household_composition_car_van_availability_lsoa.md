# Census Household Composition Car Van Availability Lsoa

## Overview

- **Identifier:** `a_ons_england_wales/census_household_composition_car_van_availability_lsoa`
...
- **Table:** `census_household_composition_car_van_availability_lsoa`
- **Geometry:** GEOMETRY
- **CRS:** EPSG:27700
- **Rows:** 33251
- **Columns:** 39
...
Census Household Composition Car Van Availability Lsoa is an authoritative dataset published by Office for National Statistics. It represents census household composition car van availability lsoa features using geometry geometry.
...
| `geography` | `varchar(40)` | Name or descriptive label of the geographical area represented by the row. |
