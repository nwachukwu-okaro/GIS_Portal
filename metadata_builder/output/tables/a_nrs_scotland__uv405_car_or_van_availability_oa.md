# Uv405 Car Or Van Availability Oa

## Overview

- **Identifier:** `a_nrs_scotland/uv405_car_or_van_availability_oa`
...
- **Table:** `uv405_car_or_van_availability_oa`
...
Uv405 Car Or Van Availability Oa is an authoritative dataset published by National Records of Scotland. It contains records relating to uv405 car or van availability oa.
...
| `number_of_cars_or_vans_in_household_four_or_more_cars_or_vans` | `double precision` |  |
