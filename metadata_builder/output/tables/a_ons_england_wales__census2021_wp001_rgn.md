...
| `regions code` | `varchar` | Publisher-assigned regions code for the record. | source_identifier | Yes | No | No |
| `regions label` | `varchar` | Publisher-supplied regions label for the represented feature or record. | source_attribute | Yes | No | No |
