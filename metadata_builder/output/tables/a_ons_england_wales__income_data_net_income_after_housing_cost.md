...
| `disposable_net_annual_income_after_housing_costs` | `text` | Publisher-supplied disposable net annual income after housing costs for the represented feature or record. | source_attribute | Yes | No | No |
