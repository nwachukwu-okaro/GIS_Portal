# Boundary Census Industries County

## Overview

- **Identifier:** `a_ireland_cso/boundary_census_industries_county`
...
- **Table:** `boundary_census_industries_county`
- **Geometry:** GEOMETRY
- **CRS:** EPSG:27700
- **Rows:** 31
- **Columns:** 32
...
Boundary Census Industries County is an authoritative dataset published by Central Statistics Office Ireland. It represents boundary census industries county features using geometry geometry.
