...
| `position_in_communal_estab_and_sex_and_age_total` | `bigint` | Count or numeric value for position in communal estab and sex and age total in the represented area. |
