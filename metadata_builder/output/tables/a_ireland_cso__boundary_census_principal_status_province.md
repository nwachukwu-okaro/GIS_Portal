# Boundary Census Principal Status Province

## Overview

- **Identifier:** `a_ireland_cso/boundary_census_principal_status_province`
...
- **Table:** `boundary_census_principal_status_province`
- **Geometry:** GEOMETRY
- **CRS:** EPSG:27700
- **Rows:** 4
- **Columns:** 35
...
Boundary Census Principal Status Province is an authoritative dataset published by Central Statistics Office Ireland. It represents boundary census principal status province features using geometry geometry.
