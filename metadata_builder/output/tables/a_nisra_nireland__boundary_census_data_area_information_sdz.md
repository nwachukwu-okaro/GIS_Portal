# Boundary Census Data Area Information Sdz

## Overview

- **Identifier:** `a_nisra_nireland/boundary_census_data_area_information_sdz`
...
Boundary Census Data Area Information Sdz is an authoritative dataset published by Northern Ireland Statistics and Research Agency. It represents boundary census data area information sdz features using multipolygon geometry.
