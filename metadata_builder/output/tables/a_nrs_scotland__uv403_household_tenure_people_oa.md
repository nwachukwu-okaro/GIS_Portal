...
| `social_rented_council_la_or_housing_association_registered_soci` | `double precision` | Count or numeric value for social rented council la or housing association registered soci in the represented area. | statistical_value | Yes | No | No |
