# Boundary Census Industries Small Area

## Overview

- **Identifier:** `a_ireland_cso/boundary_census_industries_small_area`
...
- **Table:** `boundary_census_industries_small_area`
- **Geometry:** GEOMETRY
- **CRS:** EPSG:27700
- **Rows:** 18919
- **Columns:** 33
...
Boundary Census Industries Small Area is an authoritative dataset published by Central Statistics Office Ireland. It represents boundary census industries small area features using geometry geometry.
