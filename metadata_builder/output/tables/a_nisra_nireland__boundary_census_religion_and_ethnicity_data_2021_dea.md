...
| `religion_methodist` | `text` | Publisher-supplied religion methodist for the represented feature or record. |
...
| `religion_other_christian_religions` | `text` | Publisher-supplied religion other christian religions for the represented feature or record. |
