...
| `accommodation_type_caravan_or_other_mobile_or_temporary_structu` | `text` | Count or numeric value for accommodation type caravan or other mobile or temporary structu in the represented area. | statistical_value | Yes | No | No |
...
| `car_or_van_availability_4_cars_or_vans` | `text` | Count or numeric value for car or van availability 4 cars or vans in the represented area. | statistical_value | Yes | No | No |
| `car_or_van_availability_5_or_more_cars_or_vans` | `text` | Count or numeric value for car or van availability 5 or more cars or vans in the represented area. | statistical_value | Yes | No | No |
...
| `household_tenure_lives_rent_free` | `text` | Count or numeric value for household tenure lives rent free in the represented area. | statistical_value | Yes | No | No |
