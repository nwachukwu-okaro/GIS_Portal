# Boundary Lad Dec 2025 UK Bfc

## Overview

- **Identifier:** `a_ons_england_wales/boundary_lad_dec_2025_uk_bfc`
- **Source organisation:** Office for National Statistics
- **Source:** https://www.ons.gov.uk/methodology/geography/geographicalproducts/digitalboundaries
- **Schema:** `a_ons_england_wales`
- **Table:** `boundary_lad_dec_2025_uk_bfc`
...
Boundary Lad Dec 2025 UK Bfc is an authoritative dataset published by Office for National Statistics. It represents boundary lad dec 2025 uk bfc features using multipolygon geometry.
