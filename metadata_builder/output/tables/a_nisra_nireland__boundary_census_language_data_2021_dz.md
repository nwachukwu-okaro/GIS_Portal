...
| `knowledge_of_irish_some_ability_in_irish` | `bigint` | Count or numeric value for knowledge of irish some ability in irish in the represented area. |
...
| `knowledge_of_ulster_scots_some_ability_in_ulster_scots` | `bigint` | Count or numeric value for knowledge of ulster scots some ability in ulster scots in the represented area. |
| `main_language_english` | `text` | Count or numeric value for main language english in the represented area. |
| `main_language_other_languages` | `bigint` | Count or numeric value for main language other languages in the represented area. |
