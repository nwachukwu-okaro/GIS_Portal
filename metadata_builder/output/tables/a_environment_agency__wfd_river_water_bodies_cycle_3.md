# Wfd River Water Bodies Cycle 3

## Overview

- **Identifier:** `a_environment_agency/wfd_river_water_bodies_cycle_3`
- **Source organisation:** Environment Agency
- **Source:** https://environment.data.gov.uk/
- **Licence:** [Open Government Licence](https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/)
- **Geographic coverage:** England
- **WGS84 extent:** `[-5.666041, 49.997443, 1.728462, 55.738707]`
...
- **Table:** `wfd_river_water_bodies_cycle_3`
...
Wfd River Water Bodies Cycle 3 is an authoritative dataset published by Environment Agency. It represents wfd river water bodies cycle 3 features using multilinestring geometry.
