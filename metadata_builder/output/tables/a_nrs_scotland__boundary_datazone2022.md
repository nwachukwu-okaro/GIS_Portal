...
| `dzcode` | `varchar(254)` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
| `dzname` | `varchar(254)` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
...
| `st_area_sh` | `double precision` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
| `st_length_` | `double precision` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
