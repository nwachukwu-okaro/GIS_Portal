...
| `married_or_civil_partnership_couple_household_no_dependent_chil` | `double precision` | Count or numeric value for married or civil partnership couple household number dependent chil in the represented area. |
| `married_or_civil_partnership_couple_household_with_dependent_ch` | `double precision` | Count or numeric value for married or civil partnership couple household with dependent ch in the represented area. |
