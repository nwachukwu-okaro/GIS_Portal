...
| `distance_travelled_to_study_no_fixed_place` | `text` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
| `distance_travelled_to_study_outside_northern_ireland` | `text` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
...
| `method_of_travel_to_study_other` | `text` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
...
| `method_of_travel_to_work_other` | `text` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
