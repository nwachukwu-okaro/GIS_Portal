...
|---|---|---|---|---|---|---|
| `shd_pk` | `integer` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
...
| `devaddress` | `varchar(254)` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
| `lodgedon` | `timestamp` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
| `decision` | `varchar(39)` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
...
| `planingaty` | `varchar(37)` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
| `category` | `varchar(21)` | Source attribute; its precise meaning has not yet been documented. | Unclassified | Yes | No | No |
